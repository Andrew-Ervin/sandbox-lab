...
export function PackagePolicy({sessionFetch}:{sessionFetch:(input:RequestInfo|URL,init?:RequestInit)=>Promise<Response>}){
 ...
 return <section className="workspace-page collection-page package-policy">
  ...
  <div className="policy-columns">
   <article className="resource-card"><Network size={22}/><h2>Allowed connections</h2><p>The cloud runtime, model service and approved package registries. Direct internet and external DNS are blocked in project workspaces.</p><p>Coding tools can use the configured web search. Python has no network access. Additional destinations require approval.</p></article>
